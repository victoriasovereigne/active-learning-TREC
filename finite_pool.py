...
for test_size in test_size_set:
    ...
    for fold in xrange(1,2):
        np.random.seed(seed)
        seed = seed + fold
        result_location = '/home/nahid/UT_research/clueweb12/result_pool_'+str(datasource)+'/' + str(
        ...
        predicted_location = '/home/nahid/UT_research/clueweb12/result_pool_'+str(datasource)+'/prediction' + str(
            test_size) + '_protocol:' + protocol + '_batch:' + str(batch_size) + '_seed:' + str(n_labeled) +'_fold'+str(fold) + '_oversampling:'+str(sampling)+ '_correction:'+str(correction)+ '_iter_sampling:'+str(iter_sampling)+'.txt'

        learning_curve_location = '/home/nahid/UT_research/clueweb12/result_pool_'+str(datasource)+'/learning_curve' + str(
                ...
                if protocol == 'CAL':
                    ...
                    while not queue.empty():
                        ...
                        if correction == True:
                            ...
                            unmodified_train_X.append(correctedList)
                        else:

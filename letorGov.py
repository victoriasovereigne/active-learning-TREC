...
FEATURE_DIR_LIST = []
FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2004_hp_dataset/')
FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2003_hp_dataset/')

FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2004_np_dataset/')
FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2003_np_dataset/')

FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2004_td_dataset/')
FEATURE_DIR_LIST.append('/media/nahid/Windows8_OS/Gov/Feature_min/2003_td_dataset/')
...
if preloaded==False:
    ...
    output = open('/home/nahid/TREC/data/X_train.txt', 'ab+')
    pickle.dump(X_train, output)
    output.close()

    output = open('/home/nahid/TREC/data/y_train.txt', 'ab+')
    pickle.dump(y_train, output)
    output.close()

    output = open('/home/nahid/TREC/data/X_test.txt', 'ab+')
    pickle.dump(X_test, output)
    output.close()

    output = open('/home/nahid/TREC/data/y_test.txt', 'ab+')
    pickle.dump(y_test, output)
    output.close()
else:
    input = open('/home/nahid/TREC/data/X_train.txt', 'rb')
    X_train = pickle.load(input)
    input.close()

    input = open('/home/nahid/TREC/data/y_train.txt', 'rb')
    y_train = pickle.load(input)
    input.close()

    input = open('/home/nahid/TREC/data/X_test.txt', 'rb')
    X_test = pickle.load(input)
    input.close()

    input = open('/home/nahid/TREC/data/y_test.txt', 'rb')
...
text_file = open("/home/nahid/TREC/results_analysis_450_SVM_Gov.txt", "w")
text_file.write(s)
text_file.close()

...
result_location = '/home/nahid/UT_research/TREC/TREC8/results_80_percentage_train_Basic_KNN_over_smapling.txt'
start_topic = 401
end_topic = 451
...
for topic in xrange(start_topic,end_topic):
    ...
    if sampling == True:
        ...
        X_train = X_train_resample.tolist()
        y_train = y_train_resample.tolist()
...
'''
    ...
    model = neigh = neighbors.KNeighborsClassifier(n_neighbors=1)
